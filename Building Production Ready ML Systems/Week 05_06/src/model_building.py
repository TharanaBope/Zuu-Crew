...
#create model, build model, save model
class BaseModelBuilder(ABC): #abstract class
    def __init__(
                self,
                model_name:str,
                **kwargs
...
class RandomForestModelBuilder(BaseModelBuilder):#inherits from BaseModelBuilder 
